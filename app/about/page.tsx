    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="max-w-3xl mx-auto space-y-8">
        ...
        <div className="glass rounded-lg p-8">
          <h2 className="text-2xl font-bold mb-4 text-foreground">项目介绍</h2>
        ...
        {/* Features */}
        <div className="glass rounded-lg p-8">
          <h2 className="text-2xl font-bold mb-4 text-foreground">核心功能</h2>
        ...
        {/* Design Philosophy */}
        <div className="glass rounded-lg p-8">
          <h2 className="text-2xl font-bold mb-4 text-foreground">设计理念</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 rounded-lg bg-muted/50 border border-border">
              <h3 className="font-semibold mb-2 text-foreground">极简</h3>
              <p className="text-sm text-muted-foreground">
                简洁的界面设计，专注于内容本身，减少干扰
              </p>
            </div>
            <div className="p-4 rounded-lg bg-muted/50 border border-border">
              <h3 className="font-semibold mb-2 text-foreground">轻量</h3>
              <p className="text-sm text-muted-foreground">
                静态生成，无服务依赖，加载速度快，性能优异
              </p>
            </div>
            <div className="p-4 rounded-lg bg-muted/50 border border-border">
              <h3 className="font-semibold mb-2 text-foreground">数据分离</h3>
              <p className="text-sm text-muted-foreground">
                数据与视图分离，方便维护和扩展
              </p>
            </div>
            <div className="p-4 rounded-lg bg-muted/50 border border-border">
              <h3 className="font-semibold mb-2 text-foreground">SEO 友好</h3>
              <p className="text-sm text-muted-foreground">
        ...
        {/* Tech Stack */}
        <div className="glass rounded-lg p-8">
          <h2 className="text-2xl font-bold mb-4 text-foreground">技术栈</h2>
        ...
        <div className="glass rounded-lg p-8 text-center">
          <h2 className="text-2xl font-bold mb-4 text-foreground">联系方式</h2>
