        ...
        <div className="glass rounded-lg p-8 md:p-12">
          {website && (
            ...
            >
              ...
              <h2 className="text-2xl font-bold mb-2">{website.title}</h2>
              ...
              <div className="flex items-center justify-center gap-4">
                <button
                  onClick={handleVisit}
                  className="px-8 py-3 rounded-lg bg-gradient-to-r from-primary to-accent text-white font-medium hover:opacity-90 transition-smooth"
                >
                  访问网站
                </button>
                <button
                  onClick={handleSpin}
                  disabled={isSpinning}
                  className="px-8 py-3 rounded-lg glass border border-border font-medium hover:border-primary/50 transition-smooth disabled:opacity-50"
                >
                  {isSpinning ? "抽取中..." : "换一个"}
                </button>
              </div>
